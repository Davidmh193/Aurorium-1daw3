...
<body class="hideScroll">
	...
	<section class="contact-section">
		<div class="contact-bg">
			...
			<div class="textoh2">
				<p class="text">¡Nos encantaría saber de ti! En Aurorium estamos
					comprometidos en brindar el mejor servicio a nuestros clientes y
					resolver todas tus inquietudes. Si tienes preguntas acerca de
					nuestros productos y servicios, o si necesitas ayuda en cualquier
					aspecto, no dudes en contactarnos. Puedes llenar el formulario a
					continuación, o si prefieres, puedes encontrarnos en nuestras redes
					sociales. ¡Estamos ansiosos por escucharte y ayudarte en todo lo
					que podamos!</p>
			</div>
		</div>
		...
		<div class="contact-body">
			<div class="contact-info">
				<div>
					<span><i class="fas fa-mobile-alt"></i></span> <span>Telefono</span>
					<span class="text">9426515168</span>
				</div>
				<div>
					<span><i class=""></i></span> <span>@E-mail</span> <span
						class="text">Aurorium@gmail.com</span>
				</div>
				<div>
					<span><i class="fas fa-map-marker-alt"></i></span> <span>Direccion</span>
					<span class="text">The Residence Maldives at Dhigurah</span>
				</div>
				<div>
					<span><i class="fas fa-clock"></i></span> <span>Abierto</span> <span
						class="text">Lunes - Domingo (9:30 de la mañana a 4:00 de
						la mañana)</span>
				</div>
			</div>
			...
			<div class="contact-form">
				<form method="post" action="Contacto">
					...
					<button class="learn-more">
						...
						</span> <span type="submit" class="button-text">Enviar</span>
					</button>
				</form>

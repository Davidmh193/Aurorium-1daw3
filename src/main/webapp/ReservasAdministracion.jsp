				...
				<div class="links" id="links">
					<div class="wrapper-links">
						...
						<a href="Administracion" class="link "><i
							...
							href="ReservasAdministracionSer" class="link active"><i
					...
					<nav>
						...
						<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
							...
							<a class="nav-item nav-link active" id="nav-home-tab"
								...
								aria-controls="nav-home" aria-selected="true">Reservas
								habitaciones </a> <a class="nav-item nav-link" id="nav-profile-tab"
								data-toggle="tab" href="#nav-profile" role="tab"
								aria-controls="nav-profile" aria-selected="false">Reservas
						...
						<div class="tab-pane fade show active" id="nav-home"
							...
							<table
								...
								<tbody>
									...
									<c:forEach items="${reservashabitaciones}" var="reserva">

										<tr>

											<td>${reserva.idHabitacion}</td>

											<td>${reserva.dniClientes}</td>
										...
										Modificar
  											...
  											<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
   											<form method="POST" action="ReservasHabitacionesSer" class="form">
    											<label for="idhabitacion" class="label">Id Habitacion</label>
    											<input type="text" id="username" name="Habitaciones" required="" class="input">
    											
											    <label for="precio" class="label">DNI Reservante</label>
											  	<input type="text" id="email" name="dni" required="" class="input">
											  	
											    <label for="password" class="label">Fecha Entrada</label>
											    <input type="Date" id="password" name="Entrada" required="" class="input">
											    
											     <label for="tipohabitacion" class="label">FechaSalida</label>
											    <input type="Date" id="username" name="Salida" required="" class="input">
						...
						<div class="tab-pane fade" id="nav-profile" role="tabpanel"
							...
							<table
								...
								<tbody>
									...
									<c:forEach items="${actividadescreadas1}" var="actividad">
										<tr>
											<td>${actividad.codigo_actividad}</td>

											<td>${actividad.fecha_actividad}</td>

											<td>${actividad.dni_cliente}</td>

											<td>${actividad.actividad_pagada}</td>
											<!-- actualizar y eliminar -->

						
											<td><a
												href="/Aurorium/Eliminaractividad?q=Actividad&id=${actividad.codigo_actividad}"><i
													class="fa-solid fa-trash-can fa-lg"></i></a></td>

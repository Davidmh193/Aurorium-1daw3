...
<body class="hideScroll">
			...
			<nav class="wrapper">
				...
				<div class="links" id="links">
					<div class="wrapper-links">
						...
						<a href="Administracion" class="link "><i class="fa fa-archive"></i></q> Administracion</a>
						<a href="ContactoEmpleados" class="link active"><i class="fa fa-address-book-o"></i></q> Contacto</a>
                  <a href="ReservasAdministracionSer" class="link"><i class="fa fa-calendar-check-o"></i></q> Reservas</a>
                   <a href="Empleados" class="link"><i class="fa fa-users"></i></q> Empleados</a>
	...
	<section id="tabs" class="project-tab"
		...
		<div class="container">
					...
					<nav>
						...
						<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
							...
							<a class="nav-item nav-link active" id="nav-home-tab"
								...
								aria-controls="nav-home" aria-selected="true">Contacto
						...
						<div class="tab-pane fade show active" id="nav-home"
							...
							<table
								...
								<tbody>
									...
									<c:forEach items="${contacto}" var="contactosmensajes">

										<tr>

											<td>${contactosmensajes.dni}</td>

											<td>${contactosmensajes.nombreapellido}</td>

											<td>${contactosmensajes.email}</td>

											<td>${contactosmensajes.telefono}</td>

											<td>${contactosmensajes.mensaje}</td>
		 ...
		 <footer>
      <div class="footer"style="bottom:0; width:100%; position:absolute;">

...
<div class="CuadroBlanco1">
    <div>
        ...
        <p style="margin-bottom: 5.5%;"> 
            <br>
            En Aurorium, ofrecemos una experiencia de hospedaje única e inolvidable. Nuestras habitaciones están diseñadas para brindarle la máxima comodidad y relajación durante su estadía.
            No importa si está buscando un lugar para relajarse o un destino para explorar y descubrir nuevos lugares, Aurorium es la elección perfecta para su próxima aventura vacacional. ¡Reserve ahora y descubra todo lo que Aurorium tiene para ofrecer!</p>
            
            <button class="botonesReservas1">
                <span class="circle1" aria-hidden="true">
                  <span class="icon1 arrow1"></span>
                </span>
                <span class="button-text1">Habitaciones</span>
              </button>
